...
const SITE_URL = 'https://websummoner.riadvice.com/ggr';
...
const lines = [
  '# Ggr docs',
  '',
  '> Guides and references for Ggr — a lightweight active load balancer for',
  '> scalable, highly-available Selenium clusters. Maintained by RIADVICE.',
  '',
];
