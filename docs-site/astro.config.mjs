...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      head: [
        ...analytics,
        { tag: 'meta', attrs: { property: 'og:image', content: 'https://websummoner.riadvice.com/ggr/img/og-image.jpg' } },
        { tag: 'meta', attrs: { name: 'twitter:card', content: 'summary_large_image' } },
        { tag: 'meta', attrs: { name: 'twitter:image', content: 'https://websummoner.riadvice.com/ggr/img/og-image.jpg' } },
      ],
